...
export const removeLikeFromPost = createAsyncThunk(
  ...
  async ({ userId, postId }) => {
    try {
      ...
      if (docSnap.exists()) {
        const postData = docSnap.data();
        // the likes constant will contain all the elements from postData.likes except for the one that matches the userId. 
        //Essentially, it removes the user's like from the array of likes associated with the post data.
  ...
  async ({ userId,postId, newPostContent, newFile }) => {
    try {
      ...
      if (postSnap.exists()) {
        ...
        // Return the post with the updated data
